    ...
    public class AddValidator : AbstractValidator<AddOptions>
    {
        ...
        public AddValidator(IEnumerable<string> activities)
        {
            ...
            RuleFor(x => x.ActivityDate)
                ...
                .Must(ValidDate).WithMessage("The provided date is invalid. Please check the date and try again.");
            ...
            RuleFor(x => x.ActivityType)
                .Must(ValidType).WithMessage("Activity type is invalid. Use the 'activity-type' command to list allowed values.");
        ...
        private bool ValidDate(string date) => DateTime.TryParse(date, out _);

        private bool ValidType(string type) => _activities.Contains(type.ToUpper());
    }
}
